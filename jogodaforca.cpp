...
void chuta()
{
    ...
    {
        cout << "Boa! A palavra tem esta letra." << endl;
    }
    else
    {
        cout << "Errou! A palavra nao tem esta letra." << endl;
...
void adiciona_palavra(){
    ...
    lista_palavras.push_back(novo_numero);
...
int main()
{
    ...
    else
    {
        ...
        cout << "Voce gostaria de adicionar uma nova palavra ao banco? (S/N): " << endl;
        char resposta;
        cin >> resposta;
        if(resposta == 'S'){
            adiciona_palavra();
